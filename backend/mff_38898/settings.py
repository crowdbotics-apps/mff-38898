"""
Django settings for mff_38898 project.
...
WSGI_APPLICATION = 'mff_38898.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mff_38898 API",
    "DESCRIPTION": "API documentation for mff_38898 App",
    "VERSION": "v1",
}
